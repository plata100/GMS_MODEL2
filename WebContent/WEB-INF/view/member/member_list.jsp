	...
	<div style="height: 40px;width:300px;"></div>
		...
		<nav aria-label="Page navigation" style="width:400px;margin: 0 auto;">
		  <ul class="pagination">
		    ...
		    <li>
		    	<a onclick="controller.list('member', 'member_list', '1')">
		    		<span class="glyphicon glyphicon-step-backward" aria-hidden="true"></span>
		    	</a>
		    </li>
		    <li>
		      <a onclick="controller.list('member', 'member_list', '${requestScope.prevBlock}')" aria-label="Previous">
		    ...
		    <c:forEach varStatus="i" begin="${requestScope.startPage}" 
		    	...
		    	<c:choose>
		    		...
		    		<c:otherwise>
		    			<li ><a href="#" onclick="controller.list('member','member_list','${i.index}')">
		    				${i.index}</a></li>
		    		</c:otherwise>
		    	</c:choose>
		    </c:forEach>
		    <c:if test="${requestScope.nextBlock le requestScope.theNumberOfPages}">
		    	...
		    	<li>	
		    		<a onclick="controller.list('member', 'member_list', '${requestScope.theNumberOfPages}')" >
